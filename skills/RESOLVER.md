# oh-hermes Skill Resolver

Use these local skills when a Hermes setup task matches the trigger.

## Brain operations

| Skill | Triggers | Purpose |
| --- | --- | --- |
| `oh-brain` | memory, recall, project history, durable notes, GBrain | Use GBrain and Hermes memory deliberately before external research. |
| `oh-research` | current repo research, upstream comparison, package choice | Compare upstream projects and record source-backed decisions. |
